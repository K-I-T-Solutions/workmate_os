<template>
  <div class="customer-detail-page h-full flex flex-col p-6">
    ...
    <div v-if="loading" class="flex items-center justify-center h-64">
      <div
        class="animate-spin rounded-full h-12 w-12 border-b-2 border-accent-primary"
      ></div>
    </div>
    ...
    <div v-else-if="customer" class="space-y-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <kitPanel title="Contact Information" variant="default">
            <div class="grid grid-cols-2 gap-4">
              <div>
                <label
                  class="block text-text-secondary text-xs font-medium mb-1"
                  >Email</label
                >
              ...
              <div>
                <label
                  ...
                  >City</label
                >
                <p class="text-text-primary">{{ customer.city || "-" }}</p>
              </div>
              <div>
                <label
                  class="block text-text-secondary text-xs font-medium mb-1"
          ...
          <!-- Additional Info -->
          <kitPanel title="Additional Information" variant="default">
            <div class="space-y-3">
              <div>
                <label
                  class="block text-text-secondary text-xs font-medium mb-1"
        ...
        <div class="space-y-6">
          ...
          <kitPanel title="Statistics" variant="default">
            <div class="space-y-3">
              <div class="flex justify-between items-center">
                <span class="text-text-secondary text-sm">Total Invoices</span>
                <span class="text-text-primary font-bold">0</span>
              </div>
              <div class="flex justify-between items-center">
              ...
              <div class="flex justify-between items-center">
                <span class="text-text-secondary text-sm">Total Revenue</span>
                <span class="text-accent-primary font-bold">€0.00</span>
              </div>
            </div>
          </kitPanel>
        </div>
...
const { customer, loading, error, fetchCustomer, deleteCustomer } =
  useCustomers();
